...
// app.get("/send-emailnotification", auth, JobSeeker.renderUpdateProfilePage);
app.post("/send-emailnotification", auth, validateRequest, JobSeeker.postEmailNotification);
